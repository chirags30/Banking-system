...
#header{
    height: 100vh;
    background-image: url(images/bacj.png);
...
@media(max-width:1000px){
    ...
    <body>
        ...
        <section id="header">
            <div class="container">
                <div class="logoParent">
                    <div><img src="images/bankers.jpg" class="logo"></div>
                    <div class="titlesss" >The Sparks Foundation Bank</div>
                </div>
        ...
        <img src="images/menuicon.png" id="menuBtn">
...
<section id="features">
    <div class="feature-row">
        <div class="feature-col">
            <img src="images/dribr.png">
           <a href="transfer_money.php"> <button class="button" >Our Customers</button></a>
        </div>
        <div class="feature-col">
        ...
        <div class="feature-col">
            ...
            <a href="transfer_money.php"><button class="button" >Transfer Money</button></a>
        </div>
